...
# Load paths from environment variables or use defaults
dicom_directory = os.getenv('DICOM_DIRECTORY', 'path_to_normal_images')
test_directory = os.getenv('TEST_DIRECTORY', 'path_to_test_images')
...
def main(normal_directory, test_directory):
    ...
    # Example usage
    main(dicom_directory, test_directory)
